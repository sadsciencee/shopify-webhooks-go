...
func NewOrdersPaid(webhook webhook.ValidWebhook) (*OrdersPaid, error) {
...
type OrdersPaid struct {
	info webhook.Info
	data OrdersPaidPayload
}

func (webhook *OrdersPaid) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *OrdersPaid) GetData() (OrdersPaidPayload, error) {
	return webhook.data, nil
}

type OrdersPaidPayload struct {
