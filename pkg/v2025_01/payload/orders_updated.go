...
func NewOrdersUpdated(webhook webhook.ValidWebhook) (*OrdersUpdated, error) {
	payload := &OrdersUpdatedPayload{}
...
type OrdersUpdated struct {
	info webhook.Info
	data OrdersUpdatedPayload
}

func (webhook *OrdersUpdated) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *OrdersUpdated) GetData() (OrdersUpdatedPayload, error) {
	return webhook.data, nil
}

type OrdersUpdatedPayload struct {
