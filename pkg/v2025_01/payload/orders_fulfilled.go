...
func NewOrdersFulfilled(webhook webhook.ValidWebhook) (*OrdersFulfilled, error) {
...
type OrdersFulfilled struct {
	info webhook.Info
	data OrdersFulfilledPayload
}

func (webhook *OrdersFulfilled) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *OrdersFulfilled) GetData() (OrdersFulfilledPayload, error) {
	return webhook.data, nil
}

type OrdersFulfilledPayload struct {
