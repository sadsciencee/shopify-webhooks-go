...
func NewDraftOrdersCreate(webhook webhook.ValidWebhook) (*DraftOrdersCreate, error) {
	payload := &DraftOrdersCreatePayload{}
	...
	return &DraftOrdersCreate{
		info: info,
		data: *payload,
	}, nil
}

type DraftOrdersCreate struct {
	info webhook.Info
	data DraftOrdersCreatePayload
}

func (webhook *DraftOrdersCreate) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *DraftOrdersCreate) GetData() (DraftOrdersCreatePayload, error) {
