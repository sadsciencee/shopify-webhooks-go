...
func NewFulfillmentsCreate(webhook webhook.ValidWebhook) (*FulfillmentsCreate, error) {
	payload := &FulfillmentsCreatePayload{}
	...
	return &FulfillmentsCreate{
		info: info,
		data: *payload,
	}, nil
}

type FulfillmentsCreate struct {
	info webhook.Info
	data FulfillmentsCreatePayload
}

func (webhook *FulfillmentsCreate) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *FulfillmentsCreate) GetData() (FulfillmentsCreatePayload, error) {
	return webhook.data, nil
}

type FulfillmentsCreatePayload struct {
