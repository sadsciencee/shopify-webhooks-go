...
func NewCompanyLocationsDelete(webhook webhook.ValidWebhook) (*CompanyLocationsDelete, error) {
	payload := &CompanyLocationsDeletePayload{}
...
type CompanyLocationsDelete struct {
	info webhook.Info
	data CompanyLocationsDeletePayload
}

func (webhook *CompanyLocationsDelete) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *CompanyLocationsDelete) GetData() (CompanyLocationsDeletePayload, error) {
