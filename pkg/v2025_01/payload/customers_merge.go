...
type CustomersMergePayload struct {
	AdminGraphqlAPICustomerDeletedID string      `json:"admin_graphql_api_customer_deleted_id"`
	AdminGraphqlAPICustomerKeptID    string      `json:"admin_graphql_api_customer_kept_id"`
