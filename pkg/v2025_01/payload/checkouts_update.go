...
func NewCheckoutsUpdate(webhook webhook.ValidWebhook) (*CheckoutsUpdate, error) {
	payload := &CheckoutsUpdatePayload{}
	...
	return &CheckoutsUpdate{
		info: info,
		data: *payload,
	}, nil
}

type CheckoutsUpdate struct {
	info webhook.Info
	data CheckoutsUpdatePayload
}

func (webhook *CheckoutsUpdate) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *CheckoutsUpdate) GetData() (CheckoutsUpdatePayload, error) {
	return webhook.data, nil
}

type CheckoutsUpdatePayload struct {
