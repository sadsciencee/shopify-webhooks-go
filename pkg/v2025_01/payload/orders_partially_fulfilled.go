...
func NewOrdersPartiallyFulfilled(webhook webhook.ValidWebhook) (*OrdersPartiallyFulfilled, error) {
	...
	return &OrdersPartiallyFulfilled{
		info: info,
		data: *payload,
	}, nil
}

type OrdersPartiallyFulfilled struct {
	info webhook.Info
	data OrdersPartiallyFulfilledPayload
}

func (webhook *OrdersPartiallyFulfilled) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *OrdersPartiallyFulfilled) GetData() (OrdersPartiallyFulfilledPayload, error) {
	return webhook.data, nil
}

type OrdersPartiallyFulfilledPayload struct {
