...
func NewCompanyContactRolesRevoke(webhook webhook.ValidWebhook) (*CompanyContactRolesRevoke, error) {
	payload := &CompanyContactRolesRevokePayload{}
	...
	return &CompanyContactRolesRevoke{
		info: info,
		data: *payload,
	}, nil
}

type CompanyContactRolesRevoke struct {
	info webhook.Info
	data CompanyContactRolesRevokePayload
}

func (webhook *CompanyContactRolesRevoke) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *CompanyContactRolesRevoke) GetData() (CompanyContactRolesRevokePayload, error) {
