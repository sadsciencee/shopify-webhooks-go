...
func NewOrdersCancelled(webhook webhook.ValidWebhook) (*OrdersCancelled, error) {
...
type OrdersCancelled struct {
	info webhook.Info
	data OrdersCancelledPayload
}

func (webhook *OrdersCancelled) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *OrdersCancelled) GetData() (OrdersCancelledPayload, error) {
