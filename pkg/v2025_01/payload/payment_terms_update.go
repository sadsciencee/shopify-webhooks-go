...
func NewPaymentTermsUpdate(webhook webhook.ValidWebhook) (*PaymentTermsUpdate, error) {
	payload := &PaymentTermsUpdatePayload{}
...
type PaymentTermsUpdate struct {
	info webhook.Info
	data PaymentTermsUpdatePayload
}

func (webhook *PaymentTermsUpdate) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *PaymentTermsUpdate) GetData() (PaymentTermsUpdatePayload, error) {
