...
func NewCompanyLocationsUpdate(webhook webhook.ValidWebhook) (*CompanyLocationsUpdate, error) {
	payload := &CompanyLocationsUpdatePayload{}
	...
	return &CompanyLocationsUpdate{
		info: info,
		data: *payload,
	}, nil
}

type CompanyLocationsUpdate struct {
	info webhook.Info
	data CompanyLocationsUpdatePayload
}

func (webhook *CompanyLocationsUpdate) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *CompanyLocationsUpdate) GetData() (CompanyLocationsUpdatePayload, error) {
