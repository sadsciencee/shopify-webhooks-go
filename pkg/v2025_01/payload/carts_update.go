...
func NewCartsUpdate(webhook webhook.ValidWebhook) (*CartsUpdate, error) {
	payload := &CartsUpdatePayload{}
...
type CartsUpdate struct {
	info webhook.Info
	data CartsUpdatePayload
}

func (webhook *CartsUpdate) GetInfo() (webhook.Info, error) {
	return webhook.info, nil
}
func (webhook *CartsUpdate) GetData() (CartsUpdatePayload, error) {
	return webhook.data, nil
}

type CartsUpdatePayload struct {
